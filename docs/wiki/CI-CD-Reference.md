...
| `pytest` | `pytest tests/ -v --cov=... --cov-fail-under=25` | All PRs + push to main | Any test fails or coverage drops below 25% (64 tests total) |
