...
| **2 · Assess** | `oscal-assess` + `oscal_gap_map.py` | `gap_analysis.json` + `backlog.json` | 45 SBS controls (SFDC) / 30 WSCC controls (Workday) |
...
|---|---|
| **Platforms** | Salesforce (JWT Bearer, 45 SBS controls) · Workday (OAuth 2.0, 30 WSCC controls) |
