...
def main() -> None:
    with Diagram(
        ...
        for node in [sfdc_conn, wd_conn, osc_assess, gap_map,
                     sscf_bench, nist_skill, aicm_skill, rep_gen]:
